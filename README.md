...
Back-end for OrderEase is Restaurant System

## About

OrderEase is a web browser application with which you can manage every single aspect of your orders.
...
Set `POSTGRES_HOST` to `orderEase-postgres-development` for `.env.development` and `orderEase-postgres-test` for `.env.test` file. It is the name of the postgres container inside docker-compose file. Docker Compose will start the postgres container for you, create the database and host alias for you.
